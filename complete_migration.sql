-- Complete GetReceipts.org Database Migration
-- Run this in Supabase SQL Editor (replaces both complete_setup.sql and auth_migration.sql)
...
DROP POLICY IF EXISTS "User roles are readable" ON user_roles;
